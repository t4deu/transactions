...
.add('with multiple transactions', () => (
  <Timeline
    transactions={[
      { id: 1, type: 'credit', amount: 10.50, description: 'he Beginner Archery and Beginner Crossbow', createdAt: '10:30' },
      ...
      { id: 5, type: 'debit', amount: -140, description: 'he Beginner Archery and Beginner Crossbow', createdAt: '10:30' },
      { id: 6, type: 'credit', amount: 10, description: 'teams of eleven players with a spherical ball', createdAt: '10:30' },
    ]}
  />
))
.add('with a single transaction', () => (
  <Timeline
    transactions={[
      { id: 1, type: 'credit', amount: 10, description: 'he Beginner Archery and Beginner Crossbow', createdAt: '10:30' },
    ]}
  />
))
